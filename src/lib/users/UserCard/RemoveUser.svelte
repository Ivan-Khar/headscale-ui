...
{:else}
	<!-- Delete Warning -->
	<span in:fade|global class="font-bold text-red-400">Подтвердить удаление {user.name} </span>
	...
	>
	<span in:fade|global class="font-bold text-red-400">или отменить </span>
